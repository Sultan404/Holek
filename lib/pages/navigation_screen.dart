...
class _NavigationScreenState extends State<NavigationScreen> {
  ...
  LatLng curLocation = LatLng(24.771846, 46.672048);
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            await launchUrl(Uri.parse(
                                'google.navigation:q=${widget.lat}, ${widget.lng}&key=AIzaSyD_pFxIeBo6B9abCIckiNScTEP3egRSTCY'));
                          },
                        ),
                      ),
                    ))
  ...
  getDirections(LatLng dst) async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        'AIzaSyD_pFxIeBo6B9abCIckiNScTEP3egRSTCY',
