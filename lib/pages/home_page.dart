...
import 'package:holek/main.dart';
import 'package:holek/model/auto_complete_results.dart';
import 'package:flutter_polyline_points/flutter_polyline_points.dart';
import 'package:flip_card/flip_card.dart';
import 'package:geolocator/geolocator.dart';
import 'package:holek/provider/search_places.dart';
import 'package:holek/services/map_service.dart';
    ...
    try {
      final Marker marker = Marker(
          ...
          onTap: () {
            ...
            lat = point.latitude;
            print('${lng},!!!??!!' '${lat}');
            return _nearbyPlacesList(counter);
          },
